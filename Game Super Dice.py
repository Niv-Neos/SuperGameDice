...
roll = tk.Button(main, text = ("Roll Custom"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(-1,-1), fg = "gray99", bg = "gray3").grid(row=8,column=2,ipadx=2,ipady=5)
...
percentage = tk.Button(main, text = ("%"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,100), fg = "gray99", bg = "gray3").grid(row=8,column=7,ipadx=40,ipady=5)
