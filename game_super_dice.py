...
d2b = tk.Button(main, text = ("d2      "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d2b2 = tk.Button(main, text = ("2d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d2b3 = tk.Button(main, text = ("3d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d2b4 = tk.Button(main, text = ("4d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d2b5 = tk.Button(main, text = ("5d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d2b6 = tk.Button(main, text = ("6d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d2b7 = tk.Button(main, text = ("7d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d2b8 = tk.Button(main, text = ("8d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d2b9 = tk.Button(main, text = ("9d2    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d2b10 = tk.Button(main, text = ("10d2  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d2b11 = tk.Button(main, text = ("11d2  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d2b12 = tk.Button(main, text = ("12d2  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,2,'none'), fg = "red3", bg = "gray3").grid(row=1,column=13,ipadx=120*SCALE,ipady=5*SCALE)
                   

d4b = tk.Button(main, text = ("d4      "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d4b2 = tk.Button(main, text = ("2d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d4b3 = tk.Button(main, text = ("3d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d4b4 = tk.Button(main, text = ("4d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d4b5 = tk.Button(main, text = ("5d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d4b6 = tk.Button(main, text = ("6d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d4b7 = tk.Button(main, text = ("7d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d4b8 = tk.Button(main, text = ("8d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d4b9 = tk.Button(main, text = ("9d4    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d4b10 = tk.Button(main, text = ("10d4  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d4b11 = tk.Button(main, text = ("11d4  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d4b12 = tk.Button(main, text = ("12d4  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,4,'none'), fg = "orange", bg = "gray3").grid(row=2,column=13,ipadx=120*SCALE,ipady=5*SCALE)


d6b = tk.Button(main, text = ("d6      "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d6b2 = tk.Button(main, text = ("2d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d6b3 = tk.Button(main, text = ("3d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d6b4 = tk.Button(main, text = ("4d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d6b5 = tk.Button(main, text = ("5d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d6b6 = tk.Button(main, text = ("6d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d6b7 = tk.Button(main, text = ("7d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d6b8 = tk.Button(main, text = ("8d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d6b9 = tk.Button(main, text = ("9d6    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d6b10 = tk.Button(main, text = ("10d6  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d6b11 = tk.Button(main, text = ("11d6  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d6b12 = tk.Button(main, text = ("12d6  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,6,'none'), fg = "yellow3", bg = "gray3").grid(row=3,column=13,ipadx=120*SCALE,ipady=5*SCALE)

d8b = tk.Button(main, text = ("d8      "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d8b2 = tk.Button(main, text = ("2d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d8b3 = tk.Button(main, text = ("3d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d8b4 = tk.Button(main, text = ("4d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d8b5 = tk.Button(main, text = ("5d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d8b6 = tk.Button(main, text = ("6d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d8b7 = tk.Button(main, text = ("7d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d8b8 = tk.Button(main, text = ("8d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d8b9 = tk.Button(main, text = ("9d8    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d8b10 = tk.Button(main, text = ("10d8  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d8b11 = tk.Button(main, text = ("11d8  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d8b12 = tk.Button(main, text = ("12d8  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,8,'none'), fg = "OliveDrab2", bg = "gray3").grid(row=4,column=13,ipadx=120*SCALE,ipady=5*SCALE)

d10b = tk.Button(main, text = ("d10    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d10b2 = tk.Button(main, text = ("2d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d10b3 = tk.Button(main, text = ("3d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d10b4 = tk.Button(main, text = ("4d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d10b5 = tk.Button(main, text = ("5d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d10b6 = tk.Button(main, text = ("6d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d10b7 = tk.Button(main, text = ("7d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d10b8 = tk.Button(main, text = ("8d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d10b9 = tk.Button(main, text = ("9d10  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d10b10 = tk.Button(main, text = ("10d10"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d10b11 = tk.Button(main, text = ("11d10"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d10b12 = tk.Button(main, text = ("12d10"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,10,'none'), fg = "green3", bg = "gray3").grid(row=5,column=13,ipadx=120*SCALE,ipady=5*SCALE)

d12b = tk.Button(main, text = ("d12    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d12b2 = tk.Button(main, text = ("2d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d12b3 = tk.Button(main, text = ("3d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d12b4 = tk.Button(main, text = ("4d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d12b5 = tk.Button(main, text = ("5d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d12b6 = tk.Button(main, text = ("6d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d12b7 = tk.Button(main, text = ("7d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d12b8 = tk.Button(main, text = ("8d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d12b9 = tk.Button(main, text = ("9d12  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d12b10 = tk.Button(main, text = ("10d12"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d12b11 = tk.Button(main, text = ("11d12"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d12b12 = tk.Button(main, text = ("12d12"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,12,'none'), fg = "cyan3", bg = "gray3").grid(row=6,column=13,ipadx=120*SCALE,ipady=5*SCALE)


d20b = tk.Button(main, text = ("d20    "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=2,ipadx=120*SCALE,ipady=5*SCALE)
d20b2 = tk.Button(main, text = ("2d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(2,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=3,ipadx=120*SCALE,ipady=5*SCALE)
d20b3 = tk.Button(main, text = ("3d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(3,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=4,ipadx=120*SCALE,ipady=5*SCALE)
d20b4 = tk.Button(main, text = ("4d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(4,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=5,ipadx=120*SCALE,ipady=5*SCALE)
d20b5 = tk.Button(main, text = ("5d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(5,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=6,ipadx=120*SCALE,ipady=5*SCALE)
d20b6 = tk.Button(main, text = ("6d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(6,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=7,ipadx=120*SCALE,ipady=5*SCALE)
d20b7 = tk.Button(main, text = ("7d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(7,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=8,ipadx=120*SCALE,ipady=5*SCALE)
d20b8 = tk.Button(main, text = ("8d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(8,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=9,ipadx=120*SCALE,ipady=5*SCALE)
d20b9 = tk.Button(main, text = ("9d20  "), font = (cf.Base_Font),
            command = lambda : Roll_Dice(9,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=10,ipadx=120*SCALE,ipady=5*SCALE)
d20b10 = tk.Button(main, text = ("10d20"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(10,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=11,ipadx=120*SCALE,ipady=5*SCALE)
d20b11 = tk.Button(main, text = ("11d20"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(11,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=12,ipadx=120*SCALE,ipady=5*SCALE)
d20b12 = tk.Button(main, text = ("12d20"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(12,20,'none'), fg = "blue violet", bg = "gray3").grid(row=7,column=13,ipadx=120*SCALE,ipady=5*SCALE)
...
roll = tk.Button(main, text = ("Roll Custom"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(-1,-1,'none'), fg = "gray99", bg = "gray3").grid(row=8,column=2,ipadx=55*SCALE,ipady=5*SCALE)
...
percentage = tk.Button(main, text = ("%"), font = (cf.Base_Font),
            command = lambda : Roll_Dice(1,100,'percent'), fg = "gray99", bg = "gray3").grid(row=8,column=6,ipadx=120*SCALE,ipady=5*SCALE)
...
clear_button = tk.Button(main, text = ("Clear Log"), font = (cf.Base_Font),
            command = lambda : Clear_Log(), fg = "gray1", bg = "brown1").grid(row=1,column=1,ipadx=120*SCALE,ipady=5*SCALE)
...
log.grid(row=0,column=1,ipadx=120*SCALE)
log.config(state="disabled")
